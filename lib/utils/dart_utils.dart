...
class UtilsDate {
  ...
  static final DateFormat _fullDayFormat = DateFormat('EEE MMM dd, yyy');
  static final DateFormat _apiDayFormat = DateFormat('yyyy-MM-dd');

  static String formatMonth(DateTime d) => _monthFormat.format(d);
  static String formateDay(DateTime d) => _dayFormat.format(d);
  ...
  static List<DateTime> daysInMonth(DateTime month) {
    ...
    var last = UtilsDate.lastDayOfMonth(month);
